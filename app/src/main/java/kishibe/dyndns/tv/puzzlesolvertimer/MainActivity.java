    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stub.setOnLayoutInflatedListener(new WatchViewStub.OnLayoutInflatedListener() {
            ...
            public void onLayoutInflated(WatchViewStub stub) {
                mTextViewTimer = (TextView) stub.findViewById(R.id.textViewTimer);
                mTextViewTips = (TextView) stub.findViewById(R.id.textViewTips);

                mButtonStart = (Button) stub.findViewById(R.id.buttonStart);
                ...
                mButtonReset = (Button) stub.findViewById(R.id.buttonReset);
